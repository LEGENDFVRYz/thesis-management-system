...
interface PendingProposalFormsProps {
  data?: ProposalFormData[];
  className?: string;
  onCardClick?: (item: ProposalFormData) => void;
}

const defaultData: ProposalFormData[] = [
...
export function PendingProposalForms({ 
  data = defaultData, 
  className = '',
  onCardClick
}: PendingProposalFormsProps) {
  return (
    <div 
