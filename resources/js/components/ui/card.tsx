    ...
    "bg-card text-card-foreground flex flex-col border",
    {
      variants: {
        variant: {
          ...
          adviseeGroup: "rounded-lg bg-white border-l-primary border-l-5 gap-3 py-3 px-3 w-full md:w-[435px] h-auto md:h-[134px] shadow-md transition-all duration-300 hover:bg-breadcrumb",
        },
      },
      defaultVariants: {
        variant: "default",
      ...
      <Card variant="adviseeGroup" className={className}>
        ...
        <CardContent>
          {/* Content */}
              ...
              <div className="space-y-0 text-[8px] text-gray-600">
