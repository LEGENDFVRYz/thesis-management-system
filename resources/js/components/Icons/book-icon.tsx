...
export default function BookIcon({ className, ...props }: BookIconProps) {
    return (
        <svg
            {...props}
            className={className}
