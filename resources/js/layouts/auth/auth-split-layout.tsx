...
export default function AuthSplitLayout({
    ...
    return (
        <div className="relative h-dvh flex flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:flex-row bg-gradient-to-b from-breadcrumb via-white via-50% to-breadcrumb">

            {/* LEFT PANEL */}
            <div className="relative hidden h-screen flex-none flex-col items-start justify-between bg-gradient-to-b from-[#730000] via-[#9b000a] via-50% to-[#730000] pb-8 pl-8 pr-0 pt-8 lg:flex lg:w-80 text-white">
                {/* Top PART */}
            ...
            {/* RIGHT PANEL */}
            <div className="flex-1 flex flex-col items-center justify-center py-16 gap-16">
                {/* HEADER SECTION */}
                <div className="flex flex-col items-center justify-center">
                    <Link href={home()} className="flex flex-col items-center gap-2 font-medium">
                        <div className="mb-1 flex h-[80px] w-[80px] items-center justify-center rounded-full bg-primary/10">
                            <AppLogoIcon
                    ...
                    <div className="mt-4 text-center">
                        <h1 className="font-['DM_Sans:Medium',sans-serif] text-[22.62px] font-medium text-[#1a1a1a]">
                            Computer Engineering Thesis Portal
                        </h1>
                        <p className="font-['DM_Sans:Medium',sans-serif] text-[19.2px] text-[#5a5a5a] mt-2">
                ...
                <div className="flex items-center justify-center px-6">
                    ...
                    <div className="w-[448px]">
                        <div className="flex flex-col items-start gap-[24px] bg-white rounded-[14px] border-[0.8px] border-[rgba(115,0,0,0.15)] shadow-sm p-[0.8px]">
                            {/* Card Header */}
                            <div className="pt-[24px] px-[24px] pb-0 w-full">
                                <div className="flex flex-col gap-[10px] items-center text-center">
                                    <h1 className="font-['DM_Sans:Medium',sans-serif] text-[22.62px] font-medium text-[#1a1a1a]">{title}</h1>
                                    <p className="font-['DM_Sans:Medium',sans-serif] text-[16px] text-[#5a5a5a]">{description}</p>
                                </div>
                            </div>
                            ...
                            {canResetPassword && (
                                <div className="flex flex-col justify-center items-center h-[44px] px-[104px] pb-[24px] pt-0 gap-[10px] self-stretch w-full">
                                    <Link
                ...
                <div className="w-full flex justify-center px-6 mt-20">
                    <p className="text-[16px] text-[#5a5a5a] text-center font-['DM_Sans:Medium',sans-serif] font-medium px-8" style={{ fontVariationSettings: "'opsz' 14" }}>
                        By using this service, you understood and agree to the PUP Online Services{' '}
                        <a
                            href="https://www.pup.edu.ph/terms/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[#730000] underline hover:text-[#730000]/80"
                        >
                            Terms of Use
                        </a>
                        {' '}and{' '}
