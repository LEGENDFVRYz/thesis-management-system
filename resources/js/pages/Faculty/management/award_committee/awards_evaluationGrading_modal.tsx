                ...
                <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
                    <DialogContent className="max-w-sm p-0 gap-0 overflow-hidden [&>button]:hidden">
                        <div className="flex flex-col items-center justify-center p-6 text-center">
                            {/* Warning Icon */}
                            <div className="w-17 h-17 rounded-full flex items-center justify-center mb-4">
                                <AlertCircle size={60} className="w-17 h-17 text-primary" strokeWidth={2.5} />
                            </div>
                            ...
                            <div className="flex gap-3 w-full">
                                <Button
                                    ...
                                    className="flex-1 h-10 text-sm font-medium border-2 border-gray-900"
                                >
                                    Cancel
                                </Button>
                                <Button
                                    onClick={handleConfirmSubmit}
                                    className="flex-1 h-10 text-sm font-medium bg-red-800 hover:bg-red-900 text-white"
                                >
                                    Confirm
                                </Button>
                            </div>
                ...
                <Dialog open={showSuccessDialog} onOpenChange={handleSuccessClose}>
                    <DialogContent className="max-w-md p-0 gap-0 overflow-hidden">
                        <div className="flex flex-col items-center justify-center p-12 text-center">
                            {/* Success Icon */}
                            <div className="w-20 h-20 rounded-full bg-alert-success  flex items-center justify-center mb-6">
                                <Check size={30} className="w-16 h-16 text-white" strokeWidth={2.5} />
                            </div>
