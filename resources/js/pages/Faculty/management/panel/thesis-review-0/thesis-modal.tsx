      ...
      <DialogContent className="!w-[728px] !max-w-[728px] p-0 gap-0 rounded-[10px] border-[0.8px] border-black/10 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]">
        ...
        <div className="px-6 pt-[17px] pb-[5px] border-b-[0.8px] border-[#E5E7EB]">
          <DialogHeader className="flex flex-col items-start">
            <DialogTitle className="font-['DM_Sans'] text-[22px] font-medium leading-[29px] text-[#0A0A0A]">
              Defense Details
            </DialogTitle>
            <DialogDescription className="font-['DM_Sans'] text-[15px] font-medium leading-[20px] text-[#717182]">
        ...
        <div className="px-6 py-5 space-y-[10px] font-['DM_Sans'] max-h-[calc(90vh-100px)] overflow-y-auto">
          {/* Defense ID */}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {Array(defense.proponents).fill(null).map((_, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-2 px-2 rounded-lg bg-[rgba(255,189,0,0.5)] h-[21.59px]"
                >
                  <User size={12} strokeWidth={1} />
                  <span className="font-['Arimo'] text-[12px] leading-4 text-[#030213]">
